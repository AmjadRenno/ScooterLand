    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    YdelseMængdeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    YdelseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YdelseMængder", x => x.YdelseMængdeId);
                    table.ForeignKey(
                        name: "FK_YdelseMængder_Ordrer_OrdreId",
                        column: x => x.OrdreId,
                        principalTable: "Ordrer",
                        principalColumn: "OrdreId");
                    table.ForeignKey(
                        name: "FK_YdelseMængder_Ydelser_YdelseId",
                        column: x => x.YdelseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_YdelseMængder_OrdreId",
                table: "YdelseMængder",
                column: "OrdreId");

            migrationBuilder.CreateIndex(
                name: "IX_YdelseMængder_YdelseId",
                table: "YdelseMængder",
                column: "YdelseId");
        }
